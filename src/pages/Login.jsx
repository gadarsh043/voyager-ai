...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-6">
      ...
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary/15 via-transparent to-transparent" />
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent" />

      {/* Floating shapes */}
      <div className="fixed top-20 left-10 w-20 h-20 rounded-full bg-primary/10 blur-2xl animate-float" />
      <div className="fixed top-40 right-20 w-32 h-32 rounded-full bg-primary/5 blur-3xl animate-float" style={{ animationDelay: '-2s' }} />
      <div className="fixed bottom-32 left-1/4 w-24 h-24 rounded-full bg-primary/10 blur-2xl animate-float" style={{ animationDelay: '-4s' }} />
      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-3xl border border-border/80 bg-card/80 backdrop-blur-xl shadow-2xl shadow-primary/5 p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Sign in to plan your next adventure</p>
          </div>
